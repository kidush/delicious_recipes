defmodule DeliciousRecipes.RecipeController do
  use DeliciousRecipes.Web, :controller

  alias DeliciousRecipes.Recipe
  ...
  def create(conn, %{"recipe" => recipe_params}) do
    ...
    case Repo.insert(changeset) do
      ...
      {:error, changeset} ->
        ...
        |> render(DeliciousRecipes.ChangesetView, "error.json", changeset: changeset)
    end
  end
